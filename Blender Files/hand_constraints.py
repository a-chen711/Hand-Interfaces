    ...
    def execute(self, context):
        ...
        for x in range(2):
            ...
            if x == 0:
                ...
                yaxis = 1
                zaxis = 2
                pbone = context.object.pose.bones['Bone.020'] #Wrist rotation
                pbone.rotation_euler[xaxis] = math.radians(0)
                pbone.rotation_euler[yaxis] = math.radians(0)
                pbone.rotation_euler[zaxis] = math.radians(0)
                pbone = context.object.pose.bones['Bone.016'] #Palm rotation
                pbone.rotation_euler[xaxis] = math.radians(0.0149)
                pbone.rotation_euler[yaxis] = math.radians(0.859)
                pbone.rotation_euler[zaxis] = math.radians(8.72)
                pbone = context.object.pose.bones['Bone.017'] #Thumb rotation
                pbone.rotation_euler[xaxis] = math.radians(0)
                pbone.rotation_euler[yaxis] = math.radians(0)
                pbone.rotation_euler[zaxis] = math.radians(0)
